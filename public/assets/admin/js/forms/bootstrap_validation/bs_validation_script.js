...
(function() {
  ...
  window.addEventListener('load', function() {
    ...
    window.addEventListener('load', function() {
        // Fetch all the forms we want to apply custom Bootstrap validation styles to
        var forms = document.getElementsByClassName('custom-file-container__custom-file__custom-file-input');
        var invalid = $('.custom-file-container__custom-file__custom-file-input .invalid-feedback');
