                        ...
                        <div class="table-responsive mb-4 style-1">
                            <table id="style-1" class="table style-1 table-hover non-hover">
                                ...
                                @foreach ($projects as $project)
                                    <tr>
                                        <td class="checkbox-column"> {{ $project->id }} </td>
                                        <td class="user-name">{{ $project->title }}</td>
                                        <td>{{ $project->category }}</td>
                                        <td>{{ $project->link }}</td>
                                        <td class="text-center">
                                            <span>
                                                <img src="@if ($project->image)
                                                {{ $project->image->url() }}" class="rounded-circle profile-img" width="100" alt="avatar"></span>
                                            @else
...
{{--                                                    <a class="dropdown-item" href="javascript:void(0);">View</a>--}}
                                                    <a class="dropdown-item" href="{{ route('projects.modify', ['id' => $project->id]) }}">Edit</a>
