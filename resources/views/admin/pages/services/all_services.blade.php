                        ...
                        <div class="table-responsive mb-4 style-1">
                            <table id="style-1" class="table style-1 table-hover non-hover">
                                ...
                                @foreach ($services as $service)
                                    <tr>
                                        <td class="checkbox-column"> {{ $service->id }} </td>
                                        <td class="user-name">{{ $service->title }}</td>
                                        <td>{{ Str::limit($service->description, 70, '...') }}</td>
                                        <td class="text-center">
                                            <span><img src="@if ($service->image)
                                                {{ $service->image->url() }}" class="rounded-circle profile-img" width="100" alt="avatar"></span>
                                            @else
...
{{--                                                    <a class="dropdown-item" href="javascript:void(0);">View</a>--}}
                                                    <a class="dropdown-item" href="{{ route('services.modify', ['id' => $service->id]) }}">Edit</a>
