                                        ...
                                        <div class="col-sm-6">
                                            <div id='left-defaults' class='dragula'>
                                                ...
                                                <div class="media  d-md-flex d-block text-sm-left text-center">
                                                    <img alt="avatar" src="{{asset('storage/img/90x90.jpg')}}" class="img-fluid ">
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class="col-md-6">
                                            <div id='left-events' class='dragula'>
                                                ...
                                                <div class="media   d-block d-sm-flex">
                                                    <img alt="avatar" src="{{asset('storage/img/120x120.jpg')}}" class="img-fluid ">
                                                    <div class="media-body">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="">
                                        ...
                                        <div class="col-md-6">
                                            <div id='left-rm-spill' class='dragula'>
                                                <div class="media d-block d-sm-flex text-sm-left text-center">
                                                    <img class="" src="{{asset('storage/img/90x90.jpg')}}" alt="avatar">
                                                    <div class="media-body">
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class="col-md-6">
                                            <div id='left-rollbacks' class='dragula'>
                                                ...
                                                <div class="card post text-post" style="">
                                                    <div class="card-body">
                                                        <div class="media user-meta d-sm-flex d-block text-sm-left text-center">
                                                            <img class="" src="{{asset('storage/img/120x120.jpg')}}" alt="avatar">
                                                            <div class="media-body">
                                                            ...
                                                            <div class="col-sm-5 text-sm-left text-center">
                                                                <ul class="list-inline people-liked-img">
                                                                    <li class="list-inline-item chat-online-usr">
                                                                        <img alt="avatar" src="{{asset('storage/img/90x90.jpg')}}" class="">
                                                                    </li>
                                                                    <li class="list-inline-item chat-online-usr">
                                                ...
                                                <div class="card post text-post" style="">
                                                    <div class="card-body">
                                                        <div class="media user-meta media user-meta d-sm-flex d-block text-sm-left text-center">
                                                            <img class="" src="{{asset('storage/img/120x120.jpg')}}" alt="avatar">
                                                            <div class="media-body">
