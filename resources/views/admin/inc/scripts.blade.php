...
@switch($page_name)
    @case('analytics')
      ...
      <script src="{{ asset('assets/admin/js/dashboard/dash_2.js') }}"></script>
      @break
    ...
    @case('chat')
      {{-- App Chat --}}
      <script src="{{ asset('assets/admin/js/apps/mailbox-chat.js') }}"></script>
      @break

    @case('contacts')
      {{-- App Contact --}}
      <script src="{{ asset('plugins/jquery-ui/jquery-ui.min.js') }}"></script>
      <script src="{{ asset('assets/admin/js/apps/contact.js') }}"></script>
      @break
    ...
    @case('notes')
      {{-- App Notes --}}
      <script src="{{ asset('assets/admin/js/ie11fix/fn.fix-padStart.js') }}"></script>
      <script src="{{ asset('assets/admin/js/apps/notes.js') }}"></script>
      @break
    ...
    @case('scrumboard')
      ...
      <script src="{{ asset('plugins/jquery-ui/jquery-ui.min.js') }}"></script>
      <script src="{{ asset('assets/admin/js/ie11fix/fn.fix-padStart.js') }}"></script>
      <script src="{{ asset('assets/admin/js/apps/scrumboard.js') }}"></script>
      @break
    ...
    @case('todo-list')
      ...
      <script src="{{ asset('assets/admin/js/ie11fix/fn.fix-padStart.js') }}"></script>
      <script src="{{ asset('plugins/editors/quill/quill.js') }}"></script>
      <script src="{{ asset('assets/admin/js/apps/todoList.js') }}"></script>
      @break
    ...
    @case('auth_default')
      {{-- Auth Lockscreen --}}
      <script src="{{ asset('assets/admin/js/authentication/form-1.js') }}"></script>
      @break
    ...
    @case('accordions')
      ...
      <script src="{{ asset('assets/admin/js/scrollspyNav.js') }}"></script>
      <script src="{{ asset('assets/admin/js/components/ui-accordions.js') }}"></script>
      @break
    ...
    @case('countdown')
      ...
      <script src="{{ asset('assets/admin/js/components/custom-countdown.js') }}"></script>
      @break

    @case('counter')
      <script src="{{ asset('assets/admin/js/scrollspyNav.js') }}"></script>
      <script src="{{ asset('plugins/counter/jquery.countTo.js') }}"></script>
      <script src="{{ asset('assets/admin/js/components/custom-counter.js') }}"></script>
      @break
    ...
    @case('session_timeout')
      ...
      <script src="{{ asset('assets/admin/js/components/session-timeout/bootstrap-session-timeout.js') }}"></script>
      <script src="{{ asset('assets/admin/js/components/session-timeout/custom-bootstrap_session_timeout.js') }}"></script>
      @break
    ...
    @case('notifications')
      ...
      <script src="{{ asset('assets/admin/js/scrollspyNav.js') }}"></script>
      <script src="{{ asset('plugins/notification/snackbar/snackbar.min.js') }}"></script>
      <script src="{{ asset('assets/admin/js/components/notification/custom-snackbar.js') }}"></script>
      <script>
    ...
    @case('popovers')
      {{-- Element popovers --}}
      <script src="{{ asset('assets/admin/js/elements/popovers.js') }}"></script>
      @break

    @case('search')
      {{-- Elements Serach --}}
      <script src="{{ asset('assets/admin/js/elements/custom-search.js') }}"></script>
      @break

    @case('tooltips')
      {{-- Elemnets Tooltips --}}
      <script src="{{ asset('assets/admin/js/elements/tooltip.js') }}"></script>
      @break
    ...
    @case('coming_soon')
      {{-- Pages Coming Soon --}}
      <script src="{{ asset('assets/admin/js/pages/coming-soon/coming-soon.js') }}"></script>
      @break
    ...
    @case('faq')
      {{-- Pages FAQ --}}
      <script src="{{ asset('assets/admin/js/pages/faq/faq.js') }}"></script>
      @break

    @case('faq2')
      {{-- Pages FAQ2 --}}
      <script src="{{ asset('assets/admin/js/pages/faq/faq2.js') }}"></script>
      @break

    @case('helpdesk')
      {{-- Pages Helpdesk --}}
      <script src="{{ asset('assets/admin/js/pages/helpdesk.js') }}"></script>
      @break
    ...
    @case('account_settings')
      ...
      <script src="{{ asset('plugins/blockui/jquery.blockUI.min.js') }}"></script>
      <script src="{{ asset('assets/admin/js/users/account-settings.js') }}"></script>
      @break
    ...
    @case('widgets')
      {{-- Widgets --}}
      <script src="{{ asset('plugins/apex/apexcharts.min.js') }}"></script>
      <script src="{{ asset('assets/admin/js/widgets/modules-widgets.js') }}"></script>
      @break
    ...
    @case('clipboard')
      ...
      <script src="{{ asset('assets/admin/js/forms/custom-clipboard.js') }}"></script>
      @break
