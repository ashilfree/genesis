...
<link href="{{ asset('assets/admin/css/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
@endif
...
<link href="{{ asset('assets/admin/css/dashboard/dash_2.css') }}" rel="stylesheet" type="text/css" />
      @break
...
<link href="{{ asset('assets/admin/css/dashboard/dash_1.css') }}" rel="stylesheet" type="text/css" />
    ...
    @case('chat')
      {{-- App chat --}}
      <link href="{{ asset('assets/admin/css/apps/mailing-chat.css') }}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('contacts')
      ...
      <link href="{{ asset('assets/admin/css/apps/contacts.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('invoice')
      {{-- App invoice --}}
      <link href="{{ asset('assets/admin/css/apps/invoice.css') }}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('notes')
      {{-- App Notes --}}
      <link href="{{ asset('assets/admin/css/apps/notes.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/forms/theme-checkbox-radio.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('scrumboard')
      {{-- App Scrumboard --}}
      <link href="{{ asset('assets/admin/css/apps/scrumboard.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/forms/theme-checkbox-radio.css') }}" rel="stylesheet" type="text/css">
      @break
    ...
    @case('todo-list')
      {{-- App Todo List --}}
      <link rel="stylesheet" type="text/css" href="{{ asset('plugins/editors/quill/quill.snow.css') }}">
      <link href="{{ asset('assets/admin/css/apps/todolist.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('auth_boxed')
      {{-- Auth Lockscreen Boxed --}}
      <link href="{{ asset('assets/admin/css/main.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/authentication/form-2.css') }}" rel="stylesheet" type="text/css" />
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css/forms/theme-checkbox-radio.css') }}">
    ...
    @case('auth_default')
      {{-- Auth Lockscreen  --}}
      <link href="{{ asset('assets/admin/css/main.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/authentication/form-1.css') }}" rel="stylesheet" type="text/css" />
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css/forms/theme-checkbox-radio.css') }}">
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css/forms/switches.css') }}">
      @break
    ...
    @case('accordions')
      ...
      <link href="{{ asset('assets/admin/css/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/components/tabs-accordian/custom-accordions.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('blockui')
      {{-- Components Block ui --}}
      <link href="{{ asset('assets/admin/css/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/components/custom-modal.css') }}" rel="stylesheet" type="text/css">
    ...
    @case('bootstrap_carousel')
      ...
      <link href="{{ asset('assets/admin/css/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/components/custom-carousel.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('cards')
      {{-- Components Cards --}}
      <link href="{{ asset('assets/admin/css/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/components/cards/card.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('countdown')
      {{-- Compoents Countdown --}}
      <link href="{{ asset('assets/admin/css/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/components/custom-countdown.css') }}" rel="stylesheet" type="text/css">
      @break

    @case('counter')
      {{-- Component Counter --}}
      <link href="{{ asset('assets/admin/css/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/components/custom-counter.css') }}" rel="stylesheet" type="text/css">
      @break
    ...
    @case('list_group')
      {{-- Compoent List Group --}}
      <link href="{{ asset('assets/admin/css/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/components/custom-list-group.css') }}" rel="stylesheet" type="text/css">
      @break
    ...
    @case('media_object')
      ...
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css/forms/theme-checkbox-radio.css') }}">
      <link href="{{ asset('assets/admin/css/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/components/custom-media_object.css') }}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('sweet_alerts')
      ...
      <link href="{{ asset('plugins/sweetalerts/sweetalert2.min.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('plugins/sweetalerts/sweetalert.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/components/custom-sweetalert.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('tabs')
      {{-- Components Tabs --}}
      <link href="{{ asset('assets/admin/css/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/components/tabs-accordian/custom-tabs.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('timeline')
      {{-- Component Timeline --}}
      <link href="{{ asset('assets/admin/css/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/components/timeline/custom-timeline.css') }}" rel="stylesheet" type="text/css" />
      <style>
    ...
    @case('alerts')
      {{-- Elements Alert --}}
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css/elements/alert.css') }}">
      <style>
    ...
    @case('avatars')
      {{-- Elements avatar --}}
      <link href="{{ asset('assets/admin/css/elements/avatar.css') }}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('breadcrumbs')
      {{-- Elements Breadcrumb --}}
      <link href="{{ asset('assets/admin/css/elements/miscellaneous.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/elements/breadcrumb.css') }}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('color_library')
      ...
      <link href="{{ asset('assets/admin/css/elements/color_library.css') }}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('infobox')
      {{-- Elements Infobox --}}
      <link href="{{ asset('assets/admin/css/elements/infobox.css') }}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('popovers')
      {{-- Elements Popovers --}}
      <link href="{{ asset('assets/admin/css/elements/popover.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('search')
      {{-- Elements Search --}}
      <link href="{{ asset('assets/admin/css/elements/search.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('tooltips')
      {{-- Elements Tooltips --}}
      <link href="{{ asset('assets/admin/css/elements/tooltip.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('treeview')
      {{-- Elements Tree View --}}
      <link href="{{ asset('assets/admin/css/elements/custom-tree_view.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('typography')
      {{-- Elements Typography --}}
      <link href="{{ asset('assets/admin/css/elements/custom-typography.css') }}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('coming_soon')
      {{-- Pages Coming Soon --}}
      <link href="{{ asset('assets/admin/css/main.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/pages/coming-soon/style.css') }}" rel="stylesheet" type="text/css" />
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css/forms/theme-checkbox-radio.css') }}">
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css/forms/switches.css') }}">
      @break
    ...
    @case('contact_us')
      {{-- Pages Contact Us --}}
      <link href="{{ asset('assets/admin/css/plugins.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/pages/contact_us.css') }}" rel="stylesheet" type="text/css" />
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css/forms/theme-checkbox-radio.css') }}">
      <style>
        #content {
            width: 100%;
    ...
    @case('error404')
      {{-- Pages Error 404 --}}
      <link href="{{ asset('assets/admin/css/plugins.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/pages/error/style-400.css') }}" rel="stylesheet" type="text/css" />
      <style>
          #content {
              width: 100%;
              margin-top: 0;
    ...
    @case('error500')
      {{-- Pages Error 500 --}}
      <link href="{{ asset('assets/admin/css/plugins.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/pages/error/style-500.css') }}" rel="stylesheet" type="text/css" />
      <style>
        #content {
            width: 100%;
            margin-top: 0;
    ...
    @case('error503')
      {{-- Pages Error 503 --}}
      <link href="{{ asset('assets/admin/css/plugins.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/pages/error/style-503.css') }}" rel="stylesheet" type="text/css" />
      <style>
        #content {
            width: 100%;
            margin-top: 0;
    ...
    @case('faq')
      {{-- Pages Faq --}}
      <link href="{{ asset('assets/admin/css/main.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/pages/faq/faq.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('faq2')
      {{-- Pages Faq 2 --}}
      <link href="{{ asset('assets/admin/css/pages/faq/faq2.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('helpdesk')
      {{-- Pages Helpdesk --}}
      <link href="{{ asset('assets/admin/css/main.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/pages/helpdesk.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('maintenence')
      {{-- Pages Maintenence --}}
      <link href="{{ asset('assets/admin/css/plugins.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/pages/error/style-maintanence.css') }}" rel="stylesheet" type="text/css" />
      <style>
        #content {
            width: 100%;
            margin-left: 0;
    ...
    @case('privacy')
      {{-- Pages Privacy --}}
      <link href="{{ asset('assets/admin/css/main.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset('assets/admin/css/pages/privacy/privacy.css') }}" rel="stylesheet" type="text/css" />
      @break
    ...
    @case('account_settings')
      ...
      <link href="{{ asset('assets/admin/css/users/account-setting.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('profile')
      {{-- User Profile --}}
      <link href="{{ asset('assets/admin/css/users/user-profile.css') }}" rel="stylesheet" type="text/css" />
      @break

    @case('widgets')
      {{-- Widgets --}}
      <link href="{{ asset('plugins/apex/apexcharts.css') }}" rel="stylesheet" type="text/css">
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css/widgets/modules-widgets.css') }}">
      @break
    ...
    @case('clipboard')
      {{-- Forms Clipboard --}}
      <link href="{{ asset('assets/admin/css/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css/forms/custom-clipboard.css') }}">
      @break
