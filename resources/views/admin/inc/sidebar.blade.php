            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                @if ($page_name != 'alt_menu' && $page_name != 'blank_page' && $page_name != 'boxed' && $page_name != 'breadcrumb' )
                    ...
                    <li class="menu {{ ($category_name === 'dashboard') ? 'active' : '' }}">
                        <a href="/sales" data-active="{{ ($category_name === 'dashboard') ? 'true' : 'false' }}" data-toggle="collapse" aria-expanded="{{ ($category_name === 'dashboard') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
...
{{--                    </li>--}}
                    ...
                    <li class="menu {{ ($category_name === 'services') ? 'active' : '' }}">
                        <a href="#services" data-active="{{ ($category_name === 'services') ? 'true' : 'false' }}" data-toggle="collapse" aria-expanded="{{ ($category_name === 'services') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                                <span>Services</span>
                            </div>
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'services') ? 'show' : '' }}" id="services" data-parent="#accordionExample">
                            <li class="{{ ($page_name === 'all_services') ? 'active' : '' }}">
                                <a href="/services/all-services"> All Services </a>
                            </li>
                            <li class="{{ ($page_name === 'add_service') ? 'active' : '' }}">
                                <a href="/services/add-service"> Add Service </a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu {{ ($category_name === 'sliders') ? 'active' : '' }}">
                        <a href="#sliders" data-active="{{ ($category_name === 'sliders') ? 'true' : 'false' }}" data-toggle="collapse" aria-expanded="{{ ($category_name === 'sliders') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                                <span>Sliders</span>
                            </div>
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'sliders') ? 'show' : '' }}" id="sliders" data-parent="#accordionExample">
                            <li class="{{ ($page_name === 'all_sliders') ? 'active' : '' }}">
                                <a href="/sliders/all-sliders"> All Sliders </a>
                            </li>
                            <li class="{{ ($page_name === 'add_slider') ? 'active' : '' }}">
                                <a href="/sliders/add-slider"> Add Slider </a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu {{ ($category_name === 'abouts') ? 'active' : '' }}">
                        <a href="#abouts" data-active="{{ ($category_name === 'abouts') ? 'true' : 'false' }}" data-toggle="collapse" aria-expanded="{{ ($category_name === 'abouts') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                                <span>Abouts</span>
                            </div>
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'abouts') ? 'show' : '' }}" id="abouts" data-parent="#accordionExample">
                            <li class="{{ ($page_name === 'all_abouts') ? 'active' : '' }}">
                                <a href="/abouts/all-abouts"> All Abouts </a>
                            </li>
                            <li class="{{ ($page_name === 'add_about') ? 'active' : '' }}">
                                <a href="/abouts/modify-about"> Modify About </a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu {{ ($category_name === 'videos') ? 'active' : '' }}">
                        <a href="#videos" data-active="{{ ($category_name === 'videos') ? 'true' : 'false' }}" data-toggle="collapse" aria-expanded="{{ ($category_name === 'videos') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                                <span>Videos</span>
                            </div>
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'videos') ? 'show' : '' }}" id="videos" data-parent="#accordionExample">
                            <li class="{{ ($page_name === 'all_videos') ? 'active' : '' }}">
                                <a href="/videos/all-videos"> All Videos </a>
                            </li>
                            <li class="{{ ($page_name === 'add_video') ? 'active' : '' }}">
                                <a href="/videos/modify-video"> Modify Video </a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu {{ ($category_name === 'members') ? 'active' : '' }}">
                        <a href="#members" data-active="{{ ($category_name === 'members') ? 'true' : 'false' }}" data-toggle="collapse" aria-expanded="{{ ($category_name === 'members') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                                <span>Members</span>
                            </div>
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'members') ? 'show' : '' }}" id="members" data-parent="#accordionExample">
                            <li class="{{ ($page_name === 'all_members') ? 'active' : '' }}">
                                <a href="/members/all-members"> All Members </a>
                            </li>
                            <li class="{{ ($page_name === 'add_member') ? 'active' : '' }}">
                                <a href="/members/add-member"> Add Member </a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu {{ ($category_name === 'projects') ? 'active' : '' }}">
                        <a href="#projects" data-active="{{ ($category_name === 'projects') ? 'true' : 'false' }}" data-toggle="collapse" aria-expanded="{{ ($category_name === 'projects') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                                <span>Projects</span>
                            </div>
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'projects') ? 'show' : '' }}" id="projects" data-parent="#accordionExample">
                            <li class="{{ ($page_name === 'all_projects') ? 'active' : '' }}">
                                <a href="/projects/all-projects"> All Projects </a>
                            </li>
                            <li class="{{ ($page_name === 'add_project') ? 'active' : '' }}">
                                <a href="/projects/add-project"> Add Project </a>
                            </li>
                        </ul>
                    </li>
